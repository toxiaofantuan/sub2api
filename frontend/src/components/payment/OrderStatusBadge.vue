...
const statusMap: Record<OrderStatus, { key: string; class: string }> = {
  PENDING: { key: 'payment.status.pending', class: 'bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-400' },
  ...
  REFUND_REQUESTED: { key: 'payment.status.refund_requested', class: 'bg-violet-100 text-violet-800 dark:bg-violet-900/30 dark:text-violet-400' },
  REFUNDING: { key: 'payment.status.refunding', class: 'bg-violet-100 text-violet-800 dark:bg-violet-900/30 dark:text-violet-400' },
  REFUND_PENDING: { key: 'payment.status.refund_pending', class: 'bg-violet-100 text-violet-800 dark:bg-violet-900/30 dark:text-violet-400' },
