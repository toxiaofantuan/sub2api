...
const concurrencyClass = computed(() => {
  ...
  if (current > 0) return 'bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400'
...
const windowCostClass = computed(() => {
  ...
  if (current >= limit) return 'bg-rose-100 text-rose-700 dark:bg-rose-900/30 dark:text-rose-400'
  if (current >= limit * 0.8) return 'bg-sky-100 text-sky-700 dark:bg-sky-900/30 dark:text-sky-400'
...
const sessionLimitClass = computed(() => {
  ...
  if (current >= max) return 'bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400'
  if (current >= max * 0.8) return 'bg-sky-100 text-sky-700 dark:bg-sky-900/30 dark:text-sky-400'
  return 'bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400'
})
...
const rpmClass = computed(() => {
  ...
  if (rpmStrategy.value === 'tiered') {
    ...
    if (current >= base) return 'bg-rose-100 text-rose-700 dark:bg-rose-900/30 dark:text-rose-400'
  } else {
    if (current >= base) return 'bg-rose-100 text-rose-700 dark:bg-rose-900/30 dark:text-rose-400'
  }
  if (current >= base * 0.8) return 'bg-sky-100 text-sky-700 dark:bg-sky-900/30 dark:text-sky-400'
  return 'bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400'
})
