          ...
          <div v-if="showAdvancedOAuth" class="mt-3 group relative">
            ...
            >
              ...
              <span
                ...
                class="ml-auto shrink-0 rounded bg-sky-100 px-2 py-0.5 text-xs text-sky-700 dark:bg-sky-900/30 dark:text-sky-300"
              >
            ...
            <div
              v-if="!geminiAIStudioOAuthEnabled"
              class="pointer-events-none absolute right-0 top-full z-50 mt-2 w-80 rounded-md border border-sky-200 bg-sky-50 px-3 py-2 text-xs text-sky-800 opacity-0 shadow-lg transition-opacity group-hover:opacity-100 dark:border-sky-700 dark:bg-sky-900/40 dark:text-sky-200"
            >
  ...
  >
    <div class="space-y-6">
      ...
      <div class="border-t border-gray-200 pt-6 dark:border-dark-600">
        ...
        <p class="mb-4 text-xs text-sky-600 dark:text-sky-400">
