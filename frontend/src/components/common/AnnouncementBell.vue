          ...
          >
              ...
              <div class="relative z-10 flex items-start justify-between">
                <div>
                  ...
                  <p v-if="unreadCount > 0" class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                    <span class="font-medium text-dark-900 dark:text-primary-200">{{ unreadCount }}</span>
            ...
            <div class="max-h-[65vh] overflow-y-auto">
              ...
              <div v-if="loading" class="flex items-center justify-center py-16">
                <div class="relative">
                  <div class="h-12 w-12 animate-spin rounded-full border-4 border-gray-200 border-t-primary-600 dark:border-dark-600 dark:border-t-primary-300"></div>
