  ...
  <header class="app-header glass sticky top-0 z-30">
    <div class="flex h-16 items-center justify-between px-4 md:px-6">
      ...
      <div class="flex items-center gap-3">
        ...
        <div
          v-if="user"
          class="group relative hidden items-center gap-2 rounded-lg border border-sky-200/70 bg-white/65 px-3 py-1.5 shadow-glass-sm backdrop-blur-xl dark:border-sky-300/15 dark:bg-sky-400/10 sm:flex"
        >
          <svg
            class="h-4 w-4 text-sky-700 dark:text-sky-300"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
            stroke-width="1.5"
          ...
          <span
            ...
            class="rounded-full bg-sky-100 px-1.5 py-0.5 text-xs font-medium text-sky-700 dark:bg-sky-500/20 dark:text-sky-200"
          >
            {{ balanceFrozenLabel }}
          </span>
          <div
          ...
          >
            ...
            <div class="mt-2 flex items-center justify-between">
              ...
              <span class="font-medium text-sky-700 dark:text-sky-200">{{ formatHeaderMoney(frozenBalance) }}</span>
            </div>
        ...
        <div v-if="user" class="relative" ref="dropdownRef">
          ...
          >
            <div class="flex h-8 w-8 items-center justify-center overflow-hidden rounded-md bg-gradient-to-br from-sky-500 to-violet-500 text-sm font-medium text-white shadow-glass-sm shadow-sky-500/15">
              <img
                v-if="avatarUrl"
                :src="avatarUrl"
                :alt="displayName"
          ...
          <transition name="dropdown">
            <div v-if="dropdownOpen" class="dropdown right-0 mt-2 w-56">
              ...
              <div class="px-4 py-2 sm:hidden">
                ...
                <div v-if="frozenBalance > 0" class="mt-1 text-xs text-sky-600 dark:text-sky-300">
              ...
              <div v-if="showOnboardingButton" class="py-1">
