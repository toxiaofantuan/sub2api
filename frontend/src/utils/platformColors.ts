...
const BADGE: Record<Platform, string> = {
  anthropic: 'bg-slate-500/10 text-slate-600 border-slate-500/30 dark:text-slate-300',
...
const BADGE_LIGHT: Record<Platform, string> = {
  anthropic: 'bg-slate-500/10 text-slate-600 dark:bg-slate-500/10 dark:text-slate-300',
...
const BORDER: Record<Platform, string> = {
  anthropic: 'border-slate-500/20 dark:border-slate-500/20',
...
const ACCENT_BAR: Record<Platform, string> = {
  anthropic: 'bg-gradient-to-r from-slate-400 to-slate-500',
...
const TEXT: Record<Platform, string> = {
  anthropic: 'text-slate-600 dark:text-slate-400',
...
const ICON: Record<Platform, string> = {
  anthropic: 'text-slate-500 dark:text-slate-400',
...
const BUTTON: Record<Platform, string> = {
  anthropic: 'bg-slate-600 text-white hover:bg-slate-700 active:bg-slate-800 dark:bg-slate-500/80 dark:hover:bg-slate-500',
...
const DISCOUNT: Record<Platform, string> = {
  anthropic: 'bg-slate-100 text-slate-700 dark:bg-slate-900/40 dark:text-slate-300',
...
const GRADIENT: Record<Platform, string> = {
  anthropic: 'from-slate-500 to-slate-600',
