    ...
    <TablePageLayout>
      <template #filters>
        <div class="card p-4">
          ...
          <input v-model="filters.start_at" type="date" class="input table-toolbar-control" :title="t('admin.affiliates.records.startAt')" @change="reloadFromFirstPage" />
          <input v-model="filters.end_at" type="date" class="input table-toolbar-control" :title="t('admin.affiliates.records.endAt')" @change="reloadFromFirstPage" />
          </div>
